...
VALUES(N'Tạ Văn A',	'05/01/2000', N'100 Lý Thường Kiệt, Phường 14, Quận 10, Hồ Chí Minh', '998623462', N'Nữ', '1')
INSERT INTO BENHNHAN (TenBN, NgaySinh, DiaChi, DienThoai, GioiTinh, TrangThai)
VALUES(N'Trần Thị C', '26/4/2001',	N'212 Lý Thường Kiệt, Phường 14, Quận 10, Hồ Chí Minh', '982123312', N'Nam', '1')
INSERT INTO BENHNHAN (TenBN, NgaySinh, DiaChi, DienThoai, GioiTinh, TrangThai)
VALUES(N'Trần Văn A',	'01/01/1996',	N'33 Lý Chính Thắng, Phường 8, Quận 3, Tp Hồ Chí Minh',	'1256387623',	N'Nam', '1')
INSERT INTO BENHNHAN (TenBN, NgaySinh, DiaChi, DienThoai, GioiTinh, TrangThai)
VALUES(N'Võ Văn Song Toàn', 	'11/12/1990',	N'Tô Vĩnh Diện, Đông Hoà, Dĩ An, Bình Dương',	'1237646521',	N'Nam', '1')
INSERT INTO BENHNHAN (TenBN, NgaySinh, DiaChi, DienThoai, GioiTinh, TrangThai)
VALUES(N'Nguyễn Thị Thuỳ Thương', 	'02/02/2011',	N'248 Lý Chính Thắng, Phường 9, Quận 3, Hồ Chí Minh',	'983762318',	N'Nữ', '1')	
INSERT INTO BENHNHAN (TenBN, NgaySinh, DiaChi, DienThoai, GioiTinh, TrangThai)
VALUES(N'Nguyễn Thị Anh',	'14/1/1988',	N'87 Sư Vạn Hạnh, Phường 10, Quận 10, Hồ Chí Minh',	'1258730981',	N'Nữ', '1')
INSERT INTO BENHNHAN (TenBN, NgaySinh, DiaChi, DienThoai, GioiTinh, TrangThai)
VALUES(N'Nguyễn Hoàng Minh',	'15/11/2001',	N'Tô Vĩnh Diện, Đông Hoà, Dĩ An, Bình Dương',	'9857821878',	N'Nam', '1')
INSERT INTO BENHNHAN (TenBN, NgaySinh, DiaChi, DienThoai, GioiTinh, TrangThai)
VALUES(N'Nguyễn Thị Kiều',	'03/02/1996',	N'Ba Tháng Hai, Xuân Khánh, Ninh Kiều, Cần Thơ',	'1237652817',	N'Nữ', '1')
INSERT INTO BENHNHAN (TenBN, NgaySinh, DiaChi, DienThoai, GioiTinh, TrangThai)
VALUES(N'Nguyễn Thị Ngọc',	'07/02/1999',	N'Lãnh Tú, Xuân Lãnh, Đồng Xuân, Phú Yên',	'1256384921',	N'Nữ', '1')
INSERT INTO BENHNHAN (TenBN, NgaySinh, DiaChi, DienThoai, GioiTinh, TrangThai)
VALUES(N'Võ Thị Vân ANh',	'15/11/1999',	N'Lãnh Trường , Xuân Lãnh, Đồng Xuân, Phú Yên',	'1256383924',	N'Nữ', '1')
INSERT INTO BENHNHAN (TenBN, NgaySinh, DiaChi, DienThoai, GioiTinh, TrangThai)
VALUES(N'Trần Đình Ngọc',	'03/01/1990',	N'133/123C Tô Hiến Thành, Phường 13, Quận 10, Hồ Chí Minh',	'1256172111',	N'Nam', '1')
INSERT INTO BENHNHAN (TenBN, NgaySinh, DiaChi, DienThoai, GioiTinh, TrangThai)
VALUES(N'Ngô Gia Khánh',	'05/04/2005',	N'Phường Cầu Ông Lãnh, District 1, Ho Chi Minh City',	'9872019181',	N'Nữ', '1')


INSERT INTO NHANVIEN (TenNV, TenDangNhap, MatKhau, LoaiNV, TrangThai)
VALUES(N'Tạ Công Nguyên',	'admin',	'1234', '1', '1')
INSERT INTO NHANVIEN (TenNV, TenDangNhap, MatKhau, LoaiNV, TrangThai)
VALUES(N'Thạch Hoàng Long',	'admin2',	'1234', '2', '1')	
INSERT INTO NHANVIEN (TenNV, TenDangNhap, MatKhau, LoaiNV, TrangThai)
VALUES(N'Liêu Gia Khánh',	'admin3',	'1234', '2', '1')
INSERT INTO NHANVIEN (TenNV, TenDangNhap, MatKhau, LoaiNV, TrangThai)
VALUES(N'Nguyễn Thanh Long','admin4',	'1234', '2', '1')


INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('1',	'1',	'01/01/2021',	N'Dị ứng theo mùa như hắt hơi, chảy nước mũi, ngứa họng hoặc ngứa, chảy nước mắt',	N'Viêm Xoan.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('3',	'5',	'01/02/2021',	N'Chảy nước mắt, chảy nước mũi, ngứa mắt/mũi, hắt hơi, phát ban và ngứa',	N'Dấu hiệu bất thường trung bình.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('2',	'7',	'03/02/2021',	N'Ho, hắt hơi thường xuyên',	N'Viêm phế quản.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('5',	'2',	'03/03/2021',	N'Chống mặt, nhức đầu thường xuyên.',	N'Huyết áp cao.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('1',	'1',	'07/03/2021',	N'Dị ứng theo mùa như hắt hơi, chảy nước mũi, ngứa họng hoặc ngứa, chảy nước mắt',	N'Viêm Xoan.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('2',	'3',	'15/3/2021',	N'Bỏng da', 	N'Viêm da.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('4',	'4',	'22/3/2021',	N'Đau khớp, sưng và cứng khớp,  viêm khớp',	 N'Thiếu canxi.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('5',	'6',	'24/3/2021',	N'Nhói tim.',	N'Cholesterol trong máu cao vì ăn quá nhiều đồ ăn dầu mỡ.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('1',	'8',	'25/3/2021',	N'Đau khớp',	N'Sụn khớp và thiếu canxi trầm trọng.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('3',	'9',	'04/01/2021',	N'Da nổi mẩn đỏ.',	N'Thủy đậu.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('4',	'10',	'04/03/2021',	N'Đau vùng gối thường xuyên',	N'Tổn thương tủy sống.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('1',	'11',	'04/04/2021',	N'Sưng và đau nhức ở cánh tay.', N'Vết thương bị nhiềm trùng.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('3',	'12',	'04/05/2021',	N'Vết thương không ngừng chảy máu',	N'Máu khó đông.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('2',	'13',	'08/05/2021',	N'Không thụ thai trong 4 năm',	N'Viêm nang buồng trứng.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('5',	'14',	'09/05/2021',	N'Đau nhói vùng sau gáy',	 N'Co thắt cơ.', '1')
INSERT INTO PHIEUKHAM (MaNV, MaBN, NgayKham, TrieuChung, KetQua, TrangThai)
VALUES('5',	'1',	'09/05/2021',	N'Dị ứng theo mùa như hắt hơi, chảy nước mũi, ngứa họng hoặc ngứa, chảy nước mắt.',	 N'Viêm Xoan.', '1')
