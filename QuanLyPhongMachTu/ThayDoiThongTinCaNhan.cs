...
namespace QuanLyPhongMachTu
{
    public partial class ThayDoiThongTinCaNhan : Form
    {
        ...
        void CapNhatThongTin()
        {
            ...
            {
                MessageBox.Show("Vui lòng nhập đúng các thông tin bản thân !", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            else
            {
        ...
        private void txb_MatKhauMoi_TextChanged(object sender, EventArgs e)
        {
